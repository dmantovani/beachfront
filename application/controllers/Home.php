...
class Home extends CI_Controller {
	...
	public function index()
	{
		...
		$data["config"] = $this->page_model->get_config("spanish");
		$this->template->write('title', $data["config"][0]->page_title, TRUE);
		
		
		// getting destinations
		$data["destinations"] =  $this->page_model->get_destinations();
