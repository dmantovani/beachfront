    ...
    <div class="col-sm-12 no-padd">
        <div class="container-fluid top-banner no-padd  js-video-wrapper pr-video-wrapper simple fullheight light">
            ...
            <div class="content">
                ...
                <h1 class="title"><?=$config[0]->hero_title?> </h1>
                <a href="<?=base_url()?>about" class="a-btn simple">
...
<!--/HOME VIDEO-->
<!-- HOME TEXT -->
<div class="container no-padd  custom-block-01">
    <div class="row">
        <div class="col-xs-12">
...
<!-- DESTINATIOS STPLI -->
<div class="row-fluid no-padd">
    <div class="col-sm-12 no-padd " style="position:relative;">
        <div class="absolute-text">DESTINATIONS</div>
...
<div class="container no-padd">
    <div class="row custom-row-01  margin-lg-70t margin-lg-70b">
        <div class="column col-sm-12  col-lg-6 col-md-offset-0 col-md-6 col-xs-12  margin-sm-20t padd-only-xs">
            <div class="padd-only">
