...
class Gallery extends CI_Controller {
	...
	public function index()
	{
		...
		$info =  $this->page_model->get_gallery_cat();
		$data['info']=$info;
		
		$this->template->write_view('content', 'layout/gallery/gallery', $data);
		$data["dark"] = true;
	...
	public function detail()
	{
		...
		$info =  $this->page_model->get_gallery($this->uri->segment(2));
		$data['info']=$info;
		
		$this->template->write_view('content', 'layout/gallery/detail', $data);
	...
	public function pdf()
	{
		...
		$producto = $this->page_model->get_producto($_POST['producto_id']);

		echo base_url().'asset/img/uploads/'.$producto[0]->pdf;
	}
