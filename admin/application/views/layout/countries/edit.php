	...
	<div class="home-content" style="margin-top:0px; padding-top:20px;">
		...
		<div class="tab-content" id="adm_form">
		  <div class="tab-pane active" id="tab1">
			 <form method="post" action="<?php echo base_url()?>countries/update/<?=$info[0]->id?>/">
			 				 	
				<div class="td-input">
					<b>Titulo Idioma:</b><br>
					<input type="text" name="shortname" id="shortname" value="<?=$info[0]->titulo?>">
				</div>
				<div class="td-input">
					<b>ABR:</b><br>
					<input type="text" name="abr" id="abr" value="<?=$info[0]->abr?>">
				</div>
				<div class="td-input">
					<b>Descripci&oacute;n del idioma:</b><br>
					<input type="text" name="lang_name" id="lang_name" value="<?=$info[0]->lang_name?>">
				</div>
