...
class Home extends CI_Controller {
	...
	public function index()
	{
		...
		//$report_id, $dimensions=null, $metrics, $sort_metric=null, $filter=null, $start_date=null, $end_date=null, $start_index=1, $max_results=10000
		$this->gapi->requestReportData($this->config->item('ga_profile_id'), array('day'), array('sessions','users','pageviews','organicSearches','bounceRate'), 'day', '', date('Y-m-d', strtotime("-31 days")), date('Y-m-d'), 1, 500);
		...
		$data['totalResults']	= $this->gapi->getResults();
