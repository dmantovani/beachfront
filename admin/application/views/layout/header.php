...
<div class="header col-md-12">
	...
	<div class="header-info">
		...
		<div class="user-data">
			Bienvenido: <h1><?php echo $username ?> - <span><?php echo $provincia ?></span></h1>
		</div>
	</div>
	<div class="site-preview"><a href="<?php echo base_url() ?>../" target="_blank"><div class="btn btn-default btn-sm">VER SITIO</div></a></div>
</div>