	...
	<div class="home-content" style="margin-top:0px; padding-top:20px;">
		<div class="navbar-inner">
			<ul class="nav nav-tabs">
			  <li role="presentation" class="active"><a href="#tab1" data-toggle="tab">	Edit destination</a></li>
			  <!--<li role="presentation"><a href="#tab2" data-toggle="tab">Subtabla relacionada</a></li>-->
			</ul>
		</div>
		<div class="tab-content" id="adm_form">
		  <div class="tab-pane active" id="tab1">
			 <form method="post" action="<?php echo base_url()?>destinations/update/<?php echo $info[0]->{'uniq'}?>/">
			 	<!-- Nav tabs -->
			 	<ul class="nav nav-tabs">
			 	...
			 	<div class="tab-content">
			 		<?php foreach($lang as $keylang => $lan): ?>
			 			<div class="tab-pane lang-buttons <?php if($keylang == 0): ?> active <?php endif; ?>" id="sec<?php echo $lan->{'id'} ?>">
			 				...
			 				<div class="td-input">
								<b>Title:</b><br>
								<input type="text" name="nombre_<?php echo $lan->{'abr'} ?>" id="nombre" value="<?php if(isset($info[$keylang]->{'title'})) echo $info[$keylang]->{'title'} ?>">
							</div>
							
			 				<div class="td-input">
								<b>Description</b><br>
								<input type="text" name="descripcion_<?php echo $lan->{'abr'} ?>" id="descripcion" value="<?php if(isset($info[$keylang]->{'description'})) echo $info[$keylang]->{'description'} ?>">
							</div>
			 		...
			 		<?php endforeach; ?>
        				...
        				<div class="td-input">
        					<b>HOME Image:</b><br>
        					<input type="text" name="galeria8_input" id="galeria8_input" class="img-input" value="<?php echo $info[0]->{'image_home'}?>" readonly>
        					...
        					<div id="galeria8" class="upload-galeria">
        						<?php $slider_images = explode(',' , $info[$keylang]->{'image_home'}); ?>
        						<?php foreach($slider_images as $img):?>
        							<div class="list-img-gal"><div class="file-del" onclick="delFile('../../../asset/img/uploads/<?php echo $img?>',function(){}); $('#galeria8_input').val(''); $(this).parent().remove();"></div><img src="../../../../asset/img/uploads/<?php echo $img?>" width="auto" height="100"><br><input id="img_desc" type="text"></div>
        						<?php endforeach; ?>
        					</div>
        				</div>
        				...
        				<div class="td-input">
        					<b>Image:</b><br>
        					<input type="text" name="galeria7_input" id="galeria7_input" class="img-input" value="<?php echo $info[0]->{'image'}?>" readonly>
        					<div id="main_uploader">
        					...
        					<div id="galeria7" class="upload-galeria">
        						<?php $slider_images = explode(',' , $info[$keylang]->{'image'}); ?>
        						<?php foreach($slider_images as $img):?>
        							<div class="list-img-gal"><div class="file-del" onclick="delFile('../../../asset/img/uploads/<?php echo $img?>',function(){}); $('#galeria7_input').val(''); $(this).parent().remove();"></div><img src="../../../../asset/img/uploads/<?php echo $img?>" width="auto" height="100"><br><input id="img_desc" type="text"></div>
        						<?php endforeach; ?>
        					</div>
        				</div>
